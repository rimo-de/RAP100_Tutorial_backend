CLASS zcl_rap100_gen_data_090 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_090 IMPLEMENTATION.
...
*   clear data
    DELETE FROM zrap100_atrav090.
    DELETE FROM zrap100_dtrav090.

    "insert travel demo data
    INSERT zrap100_atrav090  FROM (
        SELECT
